...
<h2 class="display-4">Unos novog osiguranja</h2><br>
    ...
    <div class="h-100 d-flex align-items-center justify-content-center"> 
        <form method="post" action="index.php" style="width: 320px;">

            <!-- Ime i prezime -->
            <div class="mb-3">
                <label for="nosilac_osiguranja" class="form-label">Ime i prezime</label>*
                <input type="text" class="form-control" name="nosilac_osiguranja" required>
            </div>

            <!-- Datum rodjenja -->
            <div class="mb-3">
                <label for="datum_rodjenja" class="form-label">Datum rođenja</label>*
                <input type="date" class="form-control" name="datum_rodjenja" required>
            </div>

            <!-- Broj pasosa -->
            <div class="mb-3">
                <label for="broj_pasosa" class="form-label">Broj pasoša</label>*
                <input type="tel" class="form-control" name="broj_pasosa" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="datum_putovanja_od" class="form-control" required>

                <!-- Datum do -->
                <label for="datum_putovanja_do" class="form-label">Datum putovanja (DO)</label>*
                <input type="date" name="datum_putovanja_do" class="form-control" required>
            ...
            <button type="submit" class="btn btn-primary" name="dodaj" id="potvrdiBtn">Potvrdi</button>
